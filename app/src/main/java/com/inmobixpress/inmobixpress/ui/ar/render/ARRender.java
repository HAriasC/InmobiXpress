...
public class ARRender {
  private static final String TAG = ARRender.class.getSimpleName();
  ...
  /**
   * Constructs a ARRender object and instantiates GLSurfaceView parameters.
   *
   ...
   */
  public ARRender(GLSurfaceView glSurfaceView, Renderer renderer, AssetManager assetManager) {
    ...
    glSurfaceView.setRenderer(
        new GLSurfaceView.Renderer() {
          ...
          public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            renderer.onSurfaceCreated(ARRender.this);
          }
          ...
          public void onSurfaceChanged(GL10 gl, int w, int h) {
            viewportWidth = w;
            viewportHeight = h;
            renderer.onSurfaceChanged(ARRender.this, w, h);
          }

          @Override
          public void onDrawFrame(GL10 gl) {
            clear(/*framebuffer=*/ null, 0f, 0f, 0f, 1f);
            renderer.onDrawFrame(ARRender.this);
          }
        });
  ...
  public static interface Renderer {
    /**
     * Called by {@link ARRender} when the GL render surface is created.
     *
     * <p>See {@link GLSurfaceView.Renderer#onSurfaceCreated}.
     */
    public void onSurfaceCreated(ARRender render);

    /**
     * Called by {@link ARRender} when the GL render surface dimensions are changed.
     *
     * <p>See {@link GLSurfaceView.Renderer#onSurfaceChanged}.
     */
    public void onSurfaceChanged(ARRender render, int width, int height);

    /**
     * Called by {@link ARRender} when a GL frame is to be rendered.
     *
     * <p>See {@link GLSurfaceView.Renderer#onDrawFrame}.
     */
    public void onDrawFrame(ARRender render);
  }
