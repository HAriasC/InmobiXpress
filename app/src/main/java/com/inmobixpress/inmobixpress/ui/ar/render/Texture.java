...
public class Texture implements Closeable {
   ...
   */
  public Texture(ARRender render, Target target, WrapMode wrapMode) {
    this(render, target, wrapMode, /*useMipmaps=*/ true);
  }

  public Texture(ARRender render, Target target, WrapMode wrapMode, boolean useMipmaps) {
    this.target = target;
  ...
  public static Texture createFromAsset(
      ARRender render, String assetFileName, WrapMode wrapMode, ColorFormat colorFormat)
      throws IOException {
