 ...
 */
package com.inmobixpress.inmobixpress.ui.ar.render.arcore;
...
import com.inmobixpress.inmobixpress.ui.ar.render.VertexBuffer;
...
public class BackgroundRenderer {
   ...
   * during a {@link ARRender.Renderer} callback, typically in {@link
   * ARRender.Renderer#onSurfaceCreated()}.
   */
  public BackgroundRenderer(ARRender render) {
    cameraColorTexture =
        new Texture(
            render,
    ...
    mesh =
        new Mesh(render, Mesh.PrimitiveMode.TRIANGLE_STRIP, /*indexBuffer=*/ null, vertexBuffers, null);
  }
   ...
   */
  public void setUseDepthVisualization(ARRender render, boolean useDepthVisualization)
      throws IOException {
   ...
   */
  public void setUseOcclusion(ARRender render, boolean useOcclusion) throws IOException {
   ...
   */
  public void drawBackground(ARRender render) {
  ...
  public void drawVirtualScene(
          ARRender render, Framebuffer virtualSceneFramebuffer, float zNear, float zFar) {
